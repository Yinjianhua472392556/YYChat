...
@property (nonatomic, strong) YYFacialView *facialView;
...
- (YYFacialView *)facialView {

    if (_facialView == nil) {
        _facialView = [[YYFacialView alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width, 150)];
...
- (void)selectedFacialView:(NSString *)str {
    if ([_delegate respondsToSelector:@selector(selectedFacialView:isDelete:)]) {
...
- (void)sendFace:(EaseEmotion *)emotion {
    if ([_delegate respondsToSelector:@selector(sendFaceWithEmotion:)]) {
