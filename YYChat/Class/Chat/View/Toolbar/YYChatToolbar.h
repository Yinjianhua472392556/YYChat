...
@protocol YYChatToolbarDelegate;

@interface YYChatToolbar : UIView

@property (weak, nonatomic) id<YYChatToolbarDelegate> delegate;
@property (nonatomic) UIImage *backgroundImage;
@property (nonatomic, readonly) YYChatToolbarType chatBarType;
...
/**
 *  输入框左侧的按钮列表：YYChatToolbarItem类型
 */
@property (strong, nonatomic) NSArray *inputViewLeftItems;

/**
 *  输入框右侧的按钮列表：YYChatToolbarItem类型
 */
...
@protocol YYChatToolbarDelegate <NSObject>
