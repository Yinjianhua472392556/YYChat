...
- (void)setPlaceHolder:(NSString *)placeHolder {
    ...
    NSUInteger maxChars = [YYTextView maxCharactersPerLine];
...
- (NSUInteger)numberOfLinesOfText {
    ...
    return [YYTextView numberOfLinesForMessage:self.text];
}
...
+ (NSUInteger)numberOfLinesForMessage:(NSString *)text {
    ...
    return (text.length / [YYTextView maxCharactersPerLine]) + 1;
}
...
- (void)setup {
    ...
    self.scrollIndicatorInsets = UIEdgeInsetsMake(10.f, 0.f, 10.f, 8.f);
