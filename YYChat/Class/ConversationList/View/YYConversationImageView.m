...
@interface YYConversationImageView()
...
@implementation YYConversationImageView

+ (void)initialize {

    // UIAppearance Proxy Defaults

    YYConversationImageView *imageView = [self appearance];
...
- (void)_setupBadgeViewConstraint {
    ...
    self.badgeWidthConstraint = [NSLayoutConstraint constraintWithItem:self.badgeView attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem:nil attribute:NSLayoutAttributeNotAnAttribute multiplier:1.0 constant:self.badgeSize];
